...
export default function Welcome() {
    return (
        <div className="flex flex-col justify-center items-center h-screen px-4 sm:px-8 overflow-hidden">
            ...
            <div className="circle h-96 w-96 absolute bg-dark-purple-opacity-25 p-6 sm:p-8 rounded-full shadow-2xl text-center animate-pulse"></div>
            <div className="text-center max-w-sm w-9/10">
                ...
                <Link to="/pricing" className="relative inline-flex items-center justify-center px-4 py-1.5 border-2 border-custom-purple text-white bg-transparent font-medium text-sm rounded-md transition duration-300 ease-in-out hover:text-white hover:bg-gradient-to-br hover:from-purple-500 hover:to-pink-500 focus:outline-none focus:ring-2 focus:ring-purple-500 sm:w-auto w-full">
                    Go to pricing</Link>
            </div>
        </div>
    )

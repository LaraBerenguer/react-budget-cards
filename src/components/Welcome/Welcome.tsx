    ...
    return (
        <div className="flex justify-center items-center min-h-screen px-4 sm:px-8">
            <div className="bg-white p-8 rounded-lg shadow-lg text-center max-w-sm w-9/10">
                ...
                <Link to="/pricing" className="inline-block bg-custom-purple text-white py-2 px-6 text-base sm:text-sm sm:py-1 sm:px-4 font-bold rounded-md transition duration-300 ease-in-out hover:bg-dark-purple">
                Go to princing</Link>
            </div>
        </div>
